          ...
          {letters.map((letter, index) => (
            ...
            >
              <span
                ...
                style={{
                  color: index % 2 === 0 ? '#ffffff' : '#dc2626',
                  textShadow: index % 2 === 0
                    ? '0 0 30px rgba(220,38,38,0.8), 0 2px 8px rgba(0,0,0,0.5), 0 0 10px rgba(255,255,255,0.3)'
                    : '0 0 30px rgba(220,38,38,0.8), 0 2px 8px rgba(0,0,0,0.5)',
                  filter: stage >= 7
