...
type StudioSection =
  ...
  | 'multi-channel' | 'distribution' | 'settings' | 'ads-manager';
...
const NAV_ITEMS = [
  ...
  { id: 'ads-manager' as StudioSection, label: 'Ads Manager', icon: Megaphone },
    ...
    <div className="min-h-screen bg-[#0D0D0F] flex text-white">
      ...
      <aside className="hidden lg:flex flex-col w-60 bg-[#111113] border-r border-white/5 fixed inset-y-0 z-30">
        <div className="px-5 py-5 border-b border-white/5 flex items-center gap-3">
          ...
          <div>
            <p className="text-white font-bold text-sm leading-none">Goroti</p>
        ...
        <div className="lg:hidden fixed inset-0 z-40 flex">
          ...
          <aside className="relative w-64 bg-[#111113] border-r border-white/5 flex flex-col">
            <div className="px-5 py-5 border-b border-white/5 flex items-center gap-3">
              ...
              <div>
                <p className="text-white font-bold text-sm">Goroti Studio</p>
              </div>
            ...
            <div className="p-3 border-t border-white/5 space-y-1">
              ...
              >
                <Home className="w-4 h-4" /> Retour à Goroti
              </button>
            </div>
          </aside>
        </div>
      ...
      <div className="flex-1 lg:ml-60 flex flex-col min-h-screen">
        ...
        <main className="flex-1 overflow-y-auto">
          ...
          {section === 'ads-manager' && <AdsManagerSection onNavigate={onNavigate} />}
...
function AdsManagerSection({ onNavigate }: { onNavigate: (page: string) => void }) {
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-6xl mx-auto w-full">
      <PageHeader
        title="Ads Manager"
        subtitle="Gérez vos campagnes publicitaires et boostez votre audience"
        action={
          <button
            onClick={() => window.location.hash = 'create-ad-campaign'}
            className="px-4 py-2 bg-gradient-to-r from-red-600 to-orange-600 text-white rounded-xl hover:from-red-700 hover:to-orange-700 transition-all text-sm font-semibold flex items-center gap-2"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <Card>
          <div className="p-5">
            ...
            <p className="text-2xl font-black text-white mb-1">3,240 €</p>
            <p className="text-xs text-gray-500">Dépenses ce mois</p>
          </div>
        </Card>
        ...
        <Card>
          <div className="p-5">
            <div className="flex items-center justify-between mb-3">
              <div className="w-9 h-9 bg-blue-950/40 border border-blue-800/40 rounded-xl flex items-center justify-center">
                <Eye className="w-4 h-4 text-blue-400" />
              </div>
              <span className="text-xs text-green-500 font-medium">+24%</span>
            </div>
            <p className="text-2xl font-black text-white mb-1">450K</p>
        ...
        <Card>
          <div className="p-5">
            <div className="flex items-center justify-between mb-3">
              <div className="w-9 h-9 bg-purple-950/40 border border-purple-800/40 rounded-xl flex items-center justify-center">
                <Target className="w-4 h-4 text-purple-400" />
              </div>
              <span className="text-xs text-green-500 font-medium">+8%</span>
            </div>
            <p className="text-2xl font-black text-white mb-1">12.5K</p>
        ...
        <Card>
          <div className="p-5">
            <div className="flex items-center justify-between mb-3">
              <div className="w-9 h-9 bg-green-950/40 border border-green-800/40 rounded-xl flex items-center justify-center">
                <TrendingUp className="w-4 h-4 text-green-400" />
              </div>
              <span className="text-xs text-red-500 font-medium">-2%</span>
            </div>
            <p className="text-2xl font-black text-white mb-1">2.78%</p>
            <p className="text-xs text-gray-500">CTR Moyen</p>
          </div>
        </Card>
      </div>
      ...
      <Card className="mb-6">
        <div className="p-5 border-b border-white/5">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="font-bold text-white text-sm">Campagnes Actives</h3>
              <p className="text-xs text-gray-500 mt-0.5">2 campagnes en cours</p>
            </div>
            <button
        ...
        <div className="p-5 space-y-4">
          <div className="bg-white/5 border border-white/10 rounded-xl p-4">
            <div className="flex items-start justify-between mb-3">
              <div className="flex-1">
                <h4 className="font-bold text-white text-sm mb-1">Campagne Musique Été 2026</h4>
                <p className="text-xs text-gray-400">Pre-roll vidéo • Musique, Divertissement</p>
              </div>
              <span className="px-2 py-1 bg-green-500/20 text-green-500 border border-green-500/30 rounded-full text-xs font-medium">
                Active
              </span>
            </div>
            ...
            <div className="mb-3">
              ...
              <div className="w-full h-2 bg-gray-800 rounded-full overflow-hidden">
                <div className="h-full bg-gradient-to-r from-red-600 to-orange-600" style={{ width: '65%' }} />
              </div>
            </div>
            ...
            <div className="grid grid-cols-4 gap-3">
              ...
              <div>
                <p className="text-lg font-bold text-green-500">2.78%</p>
                <p className="text-xs text-gray-500">CTR</p>
              </div>
              <div>
                <p className="text-lg font-bold text-blue-500">0.26€</p>
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-4">
            <div className="flex items-start justify-between mb-3">
              <div className="flex-1">
                <h4 className="font-bold text-white text-sm mb-1">Lancement Produit Gaming</h4>
                <p className="text-xs text-gray-400">Bannière Display • Gaming, Tech</p>
              </div>
              <span className="px-2 py-1 bg-blue-500/20 text-blue-500 border border-blue-500/30 rounded-full text-xs font-medium">
                Planifiée
              </span>
            </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <button
          onClick={() => window.location.hash = 'create-ad-campaign'}
          className="p-5 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition-all text-left group"
        >
          <div className="w-10 h-10 bg-red-950/40 border border-red-800/40 rounded-xl flex items-center justify-center mb-3 group-hover:bg-red-600 transition-colors">
            <Target className="w-5 h-5 text-red-400 group-hover:text-white" />
          </div>
          <h3 className="font-bold text-white text-sm mb-1">Créer une Campagne</h3>
          <p className="text-xs text-gray-400">Lancez une nouvelle campagne publicitaire</p>
        </button>

        <button
          onClick={() => window.location.hash = 'ad-payment'}
          className="p-5 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition-all text-left group"
        >
          <div className="w-10 h-10 bg-green-950/40 border border-green-800/40 rounded-xl flex items-center justify-center mb-3 group-hover:bg-green-600 transition-colors">
            <CreditCard className="w-5 h-5 text-green-400 group-hover:text-white" />
          </div>
          <h3 className="font-bold text-white text-sm mb-1">Recharger Budget</h3>
          <p className="text-xs text-gray-400">Ajoutez du crédit à votre compte pub</p>
        </button>
        ...
        <button
          ...
          className="p-5 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition-all text-left group"
        >
          <div className="w-10 h-10 bg-blue-950/40 border border-blue-800/40 rounded-xl flex items-center justify-center mb-3 group-hover:bg-blue-600 transition-colors">
            <BarChart3 className="w-5 h-5 text-blue-400 group-hover:text-white" />
          </div>
          <h3 className="font-bold text-white text-sm mb-1">Voir Analytics</h3>
          <p className="text-xs text-gray-400">Analysez vos performances détaillées</p>
        </button>
      </div>

      {/* Info Banner */}
      <div className="mt-6 bg-gradient-to-r from-red-950/40 to-orange-950/40 border border-red-800/40 rounded-xl p-5">
        <div className="flex items-start gap-3">
          <div className="w-8 h-8 bg-red-600 rounded-lg flex items-center justify-center flex-shrink-0">
            <Megaphone className="w-4 h-4 text-white" />
          </div>
          <div>
            <h3 className="font-bold text-white text-sm mb-1">Boostez votre audience avec Goroti Ads</h3>
            <p className="text-xs text-gray-300 mb-3">
              Promouvez vos vidéos, chaînes et communautés auprès de millions d'utilisateurs. Ciblage précis, résultats mesurables.
            </p>
            <button
              onClick={() => window.location.hash = 'create-ad-campaign'}
              className="px-4 py-2 bg-gradient-to-r from-red-600 to-orange-600 text-white rounded-lg hover:from-red-700 hover:to-orange-700 transition-all text-xs font-semibold"
            >
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-500 text-xs">Système anti-fausses vues Goroti</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
        ...
        <div className="space-y-4">
          ...
          <Card className="p-5">
            ...
            <div className="flex justify-between text-xs text-gray-500">
              ...
              <span className="flex items-center gap-1.5"><span className="w-2 h-2 bg-red-600 rounded-full inline-block" /> Goroti 15% — {(STATS.gross_revenue - STATS.net_revenue).toFixed(0)}€</span>
            </div>
          </Card>
      ...
      <Card className="p-5">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-gray-500 text-xs">Vendez vos services aux créateurs Goroti</p>
          </div>
        ...
        <div className="grid grid-cols-3 gap-2 text-center">
          {[{ l: 'Commission', v: '10%' }, { l: 'Paiement escrow', v: 'Sécurisé' }, { l: 'Arbitrage', v: 'Goroti' }].map(i => (
